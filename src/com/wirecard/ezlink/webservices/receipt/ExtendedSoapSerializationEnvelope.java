...
public class ExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://ezlinkwebservices.com/service/Reciept/request^^EZLING_WS_HEADER",EZLING_WS_HEADER.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/request^^EZLING_WS_REQ_BODY",EZLING_WS_REQ_BODY.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/request^^RecieptReq",RecieptReq.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/request^^RecieptReqError",RecieptReqError.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^EZLING_WS_RES_ENV",EZLING_WS_RES_ENV.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^EZLING_WS_HEADER",EZLING_WS_HEADER_1.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^EZLING_WS_RES_BODY",EZLING_WS_RES_BODY.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^RecieptRes",RecieptRes.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^RecieptResError",RecieptResError.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept^^RecieptFault",RecieptFault.class);
    }   
