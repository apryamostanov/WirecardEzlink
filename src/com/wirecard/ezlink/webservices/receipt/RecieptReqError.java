...
public class RecieptReqError extends AttributeContainer implements KvmSerializable
{
    ...
    public RecieptReqError ()
    {
    }

    public RecieptReqError(String rEERRORCODE, String rEERRORDESC) {
		REERRORCODE = rEERRORCODE;
		REERRORDESC = rEERRORDESC;
	}

	public RecieptReqError (java.lang.Object paramObj,ExtendedSoapSerializationEnvelope __envelope)
    {
