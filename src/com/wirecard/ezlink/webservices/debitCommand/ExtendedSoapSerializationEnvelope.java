...
public class ExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand/request^^EZLING_WS_HEADER",EZLING_WS_HEADER.class);
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand/request^^EZLING_WS_REQ_BODY",EZLING_WS_REQ_BODY.class);
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand/request^^DebitCommandReq",DebitCommandReq.class);
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand/response^^EZLING_WS_RES_ENV",EZLING_WS_RES_ENV.class);
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand/response^^EZLING_WS_HEADER",EZLING_WS_HEADER_1.class);
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand/response^^EZLING_WS_RES_BODY",EZLING_WS_RES_BODY.class);
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand/response^^DebitCommandRes",DebitCommandRes.class);
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand/response^^DebitCommandResError",DebitCommandResError.class);
        classNames.put("http://ezlinkwebservices.com/service/DebitCommand^^DebitCommandFault",DebitCommandFault.class);
    }   
