...
public class DebitCommandSoap
{
    interface SBIIWcfMethod
    {
    ...
    String url = StringConstants.WebserviceConnectionUrl.URL_DEBIT;
    ...
    public DebitCommandSoap(){}

    public DebitCommandSoap (IServiceEvents callback)
    {
        this.callback = callback;
    }
    public DebitCommandSoap(IServiceEvents callback,String url)
    {
        this.callback = callback;
        this.url = url;
    }

    public DebitCommandSoap(IServiceEvents callback,String url,int timeOut)
    {
        this.callback = callback;
        this.url = url;
    ...
    public EZLING_WS_RES_ENV DebitCommand(final EZLING_WS_HEADER EZLING_WS_HEADER,final EZLING_WS_REQ_BODY EZLING_WS_REQ_BODY ) throws java.lang.Exception
    {
        return (EZLING_WS_RES_ENV)execute(new SBIIWcfMethod()
        {
            @Override
            public ExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
              ExtendedSoapSerializationEnvelope __envelope = createEnvelope();
                __envelope.addMapping("http://ezlinkwebservices.com/service/DebitCommand/request","EZLING_WS_HEADER",new EZLING_WS_HEADER().getClass());
                __envelope.addMapping("http://ezlinkwebservices.com/service/DebitCommand/request","EZLING_WS_REQ_BODY",new EZLING_WS_REQ_BODY().getClass());
                SoapObject __soapReq = new SoapObject("http://ezlinkwebservices.com/service/DebitCommand/request", "EZLING_WS_REQ_ENV");
                __envelope.setOutputSoapObject(__soapReq);
                
                PropertyInfo __info=null;
                __info = new PropertyInfo();
                __info.namespace="http://ezlinkwebservices.com/service/DebitCommand/request";
    ...
    public android.os.AsyncTask< Void, Void, OperationResult< EZLING_WS_RES_ENV>> DebitCommandAsync(final EZLING_WS_HEADER EZLING_WS_HEADER,final EZLING_WS_REQ_BODY EZLING_WS_REQ_BODY)
    {
        return executeAsync(new Functions.IFunc< EZLING_WS_RES_ENV>() {
            public EZLING_WS_RES_ENV Func() throws java.lang.Exception {
                return DebitCommand( EZLING_WS_HEADER,EZLING_WS_REQ_BODY);
            }
        });
    }

    
    protected java.lang.Object execute(SBIIWcfMethod wcfMethod,String methodName) throws java.lang.Exception
    {
    ...
    java.lang.Exception convertToException(org.ksoap2.SoapFault fault,ExtendedSoapSerializationEnvelope envelope)
    {
        ...
        if(fault.detail!=null && fault.detail.getChildCount()>0)
        {
            ...
            try
            {
                ...
                exceptionObject=envelope.GetExceptionDetail(detailsNode,"http://ezlinkwebservices.com/service/DebitCommand","DebitCommandFault");
                if (exceptionObject != null)
                {
                    return new DebitCommandFault(exceptionObject,envelope);
                }
            }
