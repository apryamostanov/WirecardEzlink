...
public class HTIMarshalDate implements Marshal
{
    ...
    {
        return HTIHelper.ConvertFromWebService(parser.nextText());
    }
    ...
    {
        writer.text(HTIHelper.getDateFormat().format((Date)obj));
    }
}
