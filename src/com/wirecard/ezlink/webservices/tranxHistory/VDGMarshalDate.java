...
public class VDGMarshalDate implements Marshal
{
    ...
    {
        return VDGHelper.ConvertFromWebService(parser.nextText());
    }
    ...
    {
        writer.text(VDGHelper.getDateFormat().format((Date)obj));
    }
}
