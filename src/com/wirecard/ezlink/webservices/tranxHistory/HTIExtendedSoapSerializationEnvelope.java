...
public class HTIExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://ezlinkwebservices.com/service/Reciept/request^^EZLING_WS_HEADER",HTIEZLING_WS_HEADER.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/request^^EZLING_WS_REQ_BODY",HTIEZLING_WS_REQ_BODY.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/request^^RecieptReq",HTIRecieptReq.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/request^^RecieptReqError",HTIRecieptReqError.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^EZLING_WS_RES_ENV",HTIEZLING_WS_RES_ENV.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^EZLING_WS_HEADER",HTIEZLING_WS_HEADER_1.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^EZLING_WS_RES_BODY",HTIEZLING_WS_RES_BODY.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^RecieptRes",HTIRecieptRes.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept/response^^RecieptResError",HTIRecieptResError.class);
        classNames.put("http://ezlinkwebservices.com/service/Reciept^^RecieptFault",HTIRecieptFault.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public HTIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HTIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HTIMarshalGuid().register(this);
        new HTIMarshalDate().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=String.class)) {
                java.lang.String xmlName=HTIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,HTIExtendedSoapSerializationEnvelope.class);
