...
public class VDGTranxHistoryFault extends java.lang.Exception implements KvmSerializable
{
    ...
    public VDGTranxHistoryFault ()
    {
    }

    public VDGTranxHistoryFault (java.lang.Object paramObj,VDGExtendedSoapSerializationEnvelope __envelope)
    {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info)
    {
        if(propertyIndex==0)
        {
            ...
            info.name = "faultInfo";
            info.namespace= "http://ezlinkwebservices.com/service/TranxHistory";
        }
        if(propertyIndex==1)
        {
            info.type = PropertyInfo.STRING_CLASS;
